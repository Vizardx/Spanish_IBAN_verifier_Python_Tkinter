...
def calcular(): #RELLENAR ESTO CON INFORMACIÓN DE CUENTAS. Para uso interactivo, usar .py con TKinter
    ...
    messagebox.showinfo("IBANs", "Los IBANs son " + ', '.join(ibans))

root = tk.Tk()

button_calcular = tk.Button(root, text="Calcular IBANs", command=calcular)
